...
page {
    // Setup favion
    shortcutIcon = typo3conf/ext/ns_theme_agency/Resources/Public/img/favicon.ico
    ...
    headerData {
        ...
        10.value (
            <script>
              ...
              ga('create', '{$ns_theme_agency.website.settings.googleanalytics}', 'auto');
              ga('send', 'pageview');
            </script>
        )
    }
    ...
    includeJS{
        ...
        70 = typo3conf/ext/ns_theme_agency/Resources/Public/js/contact_me.js
